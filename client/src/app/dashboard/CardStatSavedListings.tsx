        ...
        <div className='row-span-6 md:row-span-1 md:col-span-2 xl:row-span-2 xl:col-span-2 p-8 rounded-xl bg-white'>
            {isLoading ? (
                ...
                <>
                    ...
                    <h5 className='text-5xl font-semibold text-blue-500'>{dashboardMetrics?.savedListingsCount}</h5>
                </>
            )}
        </div>
    )
...
export default CardStatSavedListings